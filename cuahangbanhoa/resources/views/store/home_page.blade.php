...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{ url('store/css/bootstrap.css') }}" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Baloo+Chettan|Poppins:400,600,700&display=swap" rel="stylesheet">
  <!-- Custom styles for this template -->
  <link href="{{ url('store/css/style.css') }}"rel="stylesheet" />
  <!-- responsive style -->
...
<body>
  ...
  <script type="text/javascript" src="{{ url('store/js/jquery-3.4.1.min.js') }}"></script>
  <script type="text/javascript" src="{{ url('store/js/bootstrap.js') }}"></script>
  <script type="text/javascript" src="{{ url('store/js/custom.js') }}"></script>
  <!-- Google Map -->
